...
> _You are currently on the **sway-animated** branch._
...
- **Classic:**
  ...
  Clone the **[sway-classic](https://github.com/sejjy/mechabar/tree/sway-classic)** branch for the classic, non-animated bar.

  ```bash
    git clone -b sway-classic https://github.com/sejjy/mechabar.git
    cd mechabar
  ```

- **Animated:**

  Clone the **sway-animated** branch, which includes launch animations.
